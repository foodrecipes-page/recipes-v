...
Recipe cache shard for **[foodrecipes.page](https://foodrecipes.page)** — AI-generated recipes whose slug starts with **the letter 'v'**.
...
```
https://cdn.jsdelivr.net/gh/foodrecipes-page/recipes-v@main/recipes/<cuisine>/<diet>/<slug>.json
```
